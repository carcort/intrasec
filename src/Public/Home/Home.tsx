    ...
    <div className="w-full h-full  grid place-items-center">
        <section className="w-[70%] h-[60%]  flex">
           <article className="w-full h-full pt-28 px-2">
            ...
            <div className="w-[90%] h-[25%] flex gap-x-5 font-semibold">
              <button onClick={handleClickIngresar} className="bg-blue-600 text-white w-full h-[40%] cursor-pointer hover:bg-blue-700">
                Ingresa
              </button>
              <button className="bg-[#38ff02] text-white w-full h-[40%] cursor-pointer hover:bg-green-600"> 
                Prueba Gratis!
              </button>
            </div>
           </article>
