...
import BadgeFormularioEmpleadoNomina from "./BadgeFormularioEmpleadoNomina"



const FormularioEmpleadoNomina = ({titulo1,  data1}) => {
  return (
     <form className='w-full h-full flex gap-x-16'>
       ...
       <section className="w-[99%] h-full">
          ...
          <main className="w-full h-[85%] grid grid-rows-6 grid-cols-2 gap-x-12">
            {data1.map((el)=>{
             return  <BadgeFormularioEmpleadoNomina
                el={el}
             />
...
export default FormularioEmpleadoNomina