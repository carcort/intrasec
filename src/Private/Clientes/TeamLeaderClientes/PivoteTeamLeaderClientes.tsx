...
const PivoteTeamLeaderClientes = ({usuario}) => {
 ...
 console.log(tipo_empresa);
  ...
  if(cargo === 'TeamLeaderClientes'){
    return <Navigate to={'/private/clientes/teamLeaderClientes/home'} replace />;
  }
...
export default PivoteTeamLeaderClientes