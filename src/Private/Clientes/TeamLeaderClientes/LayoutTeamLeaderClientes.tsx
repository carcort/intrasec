...
import { dataSidebarTeamLeaderClientes } from "./Utils/dataSidebarTeamLeaderClientes"
//import { dataSidebarGerenteClientes } from "./Utils/dataSidebarGerenteClientes"


const LayoutTeamLeaderClientes = ({usuario}) => {
  return (
     ...
     <section className="w-full h-[7%] px-3"> 
       ...
       <main className="w-full h-[88%] flex">
        <aside className="w-[3%] h-full"> 
            <Sidebar
                data= {dataSidebarTeamLeaderClientes}
            />
         </aside>
...
export default LayoutTeamLeaderClientes